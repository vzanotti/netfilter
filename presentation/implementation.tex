\section<presentation>[Implémentation]{Implémentation}
  \begin{frame}
    \frametitle{Fonctionnement du logiciel}
      \begin{itemize}
        \item<1-> Regrouper les paquets appartenant à une même connexion, grâce à \texttt{libnetfilter\_conntrack}.
        \item<2-> Déterminer si le contenu de la connexion correspond à un protocole supporté.
        \item<3-> Extraire la méthode et l'url utilisées.
  ...
  \begin{frame}
    \frametitle{Organisation du programme}
      ...
      \begin{itemize}
        ...
        \item un répertoire base, regroupant plusieurs librairies externes;
  ...
  \begin{frame}
    \frametitle{Fiabilité et limitation}
      \begin{itemize}
        ...
        \item<3-> Résitance native aux contournements par fragmentation de paquets, mais pas à celles par inversions de paquets.
        \item<4-> L'application résiste nativement aux attaques de types \emph{Denial of Service}.
