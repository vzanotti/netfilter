\section<presentation>[Principes et risques]{Les principes et les risques du filtrage}
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item<3-> Cas d'école: appliquer des règles de QoS restrictives sur les fichiers {\tt .iso}.
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item<3-> Défense: utilisation de tampons egress/ingress pour la session TCP.
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item<4-> Résultat sur un filtre à tampon naïf:\\
        {\tt\scriptsize
          > GEP/1.0T /abcd.pdf HTT
        }
      \item<4-> Défense: réordonnancement manuel (complexe, coûteux).
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}[t]
    ...
    \begin{itemize}
      ...
      \item<3-> Défense: implémenter \emph{toutes} les versions du protocole (très fastidieux, risque de faux-positifs)
    \end{itemize}
  \end{frame}
